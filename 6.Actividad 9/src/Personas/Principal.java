...
public class Principal {
	...
	public static void main(String[] args) {
		...
		*/
		...
		try{
		Empleado emp1=new Tecnico("Nacho",(byte)26,'V',"03544815l",true,"TEC13545",1500,2,(byte)2);
		//Persona emp2=new Obrero("Andrea",(byte)50,'M',"03655484F",true,"ob1",1800,'M',(byte)2);
		Empleado emp2=new Obrero("Andrea",(byte)50,'M',"03655484F",true,"OBR64825",1800,'M',(byte)2);
